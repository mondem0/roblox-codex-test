...
2. A wave is a list of spawn groups. Each group can spawn one enemy type sequentially or mix several types at the same time:
...
3. Append a new wave (or edit existing ones) to change pacing. Use as many groups per wave as you like and mix single- and multi-type groups for variety.
